...
df <- search_tweets(
  "ziarah", n = 5000, include_rts = TRUE, lang = "id", type = "recent"
)
...
write.csv(x = flatenned_tweets,
          file = '~/Projects/Twitter/SA/analisissentimen/Datasets/Data Ziarah Mentah.csv',
          row.names = FALSE)
...
write.csv(x = tweets.df,
          file = '~/Projects/Twitter/SA/analisissentimen/Datasets/Data Ziarah.csv',
          row.names = FALSE)

# Load Data from Computer
tweets.df = read.csv(file = '~/Projects/Twitter/SA/analisissentimen/Datasets/Data Ziarah.csv',
                     header = TRUE,
                     sep = ',')
...
# ===== SAVE DATA RESULTS
write.csv(x = results,
          file = '~/Projects/Twitter/SA/analisissentimen/Datasets/Sentiment Ziarah.csv',
          row.names = FALSE)
