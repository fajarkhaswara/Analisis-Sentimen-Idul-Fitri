...
df <- search_tweets(
  "idul fitri", n = 5000, include_rts = TRUE, lang = "id", type = "recent"
)
...
write.csv(x = flatenned_tweets,
          file = '~/Projects/Twitter/SA/analisissentimen/Datasets/Data Idul Fitri Mentah.csv',
          row.names = FALSE)
...
write.csv(x = tweets.df,
          file = '~/Projects/Twitter/SA/analisissentimen/Datasets/Data Idul Fitri.csv',
          row.names = FALSE)
...
# ===== SAVE DATA RESULTS
write.csv(x = results,
          file = '~/Projects/Twitter/SA/analisissentimen/Datasets/Sentiment Idul Fitri.csv',
          row.names = FALSE)
